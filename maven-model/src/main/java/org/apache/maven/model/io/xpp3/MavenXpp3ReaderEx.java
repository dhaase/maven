...
public class MavenXpp3ReaderEx
{
    ...
    } //-- org.apache.maven.model.io.xpp3.MavenDirkXpp3ReaderEx()

    public MavenXpp3ReaderEx(ContentTransformer contentTransformer)
    {
        this.contentTransformer = contentTransformer;
    } //-- org.apache.maven.model.io.xpp3.MavenDirkXpp3ReaderEx(ContentTransformer)
     ...
     * @return Dependency
     */
    private Dependency parseDependency( XmlPullParser parser, boolean strict, InputSource source, ModelBase modelBase )
            throws IOException, XmlPullParserException
    {
        String tagName = parser.getName();
        ...
        while ( ( strict ? parser.nextTag() : nextTag( parser ) ) == XmlPullParser.START_TAG )
        {
            ...
            else if ( checkFieldWithDuplicate( parser, "exclusions", null, parsed ) )
            {
                ...
                while ( parser.nextTag() == XmlPullParser.START_TAG )
                {
                    ...
                    {
                        exclusions.add( parseExclusion( parser, strict, source, modelBase ) );
                    }
                    else
                    {
                        checkUnknownElement( parser, strict );
     ...
     */
    private DependencyManagement parseDependencyManagement( XmlPullParser parser, boolean strict, InputSource source, ModelBase modelBase )
            throws IOException, XmlPullParserException
    {
        String tagName = parser.getName();
        ...
        while ( ( strict ? parser.nextTag() : nextTag( parser ) ) == XmlPullParser.START_TAG )
        {
            if ( checkFieldWithDuplicate( parser, "dependencies", null, parsed ) )
            {
                ...
                while ( parser.nextTag() == XmlPullParser.START_TAG )
                {
                    ...
                    {
                        dependencies.add( parseDependency( parser, strict, source, modelBase ) );
                    }
                    else
                    {
                        checkUnknownElement( parser, strict );
     ...
     * @return Exclusion
     */
    private Exclusion parseExclusion( XmlPullParser parser, boolean strict, InputSource source, ModelBase modelBase )
            throws IOException, XmlPullParserException
    {
        String tagName = parser.getName();
        ...
        for ( int i = parser.getAttributeCount() - 1; i >= 0; i-- )
        {
            ...
            if ( name.indexOf( ':' ) >= 0 )
            {
                HandleExchangedDependencies.parseDependency(modelBase, _location, name, value);
            }
            else
            {
                checkUnknownAttribute( parser, name, tagName, strict );
            ...
            throws IOException, XmlPullParserException
    {
        ...
        while ( ( strict ? parser.nextTag() : nextTag( parser ) ) == XmlPullParser.START_TAG )
        {
            ...
            {
                model.setDependencyManagement( parseDependencyManagement( parser, strict, source, model ) );
            }
            else if ( checkFieldWithDuplicate( parser, "dependencies", null, parsed ) )
            {
                ...
                while ( parser.nextTag() == XmlPullParser.START_TAG )
                {
                    if ( "dependency".equals( parser.getName() ) )
                    {
                        dependencies.add( parseDependency( parser, strict, source, model ) );
                    }
                    else
                    {
                        checkUnknownElement( parser, strict );
        ...
        HandleExchangedDependencies.removeDuplicates(model);
        return model;
            ...
            throws IOException, XmlPullParserException
    {
        ...
        while ( ( strict ? parser.nextTag() : nextTag( parser ) ) == XmlPullParser.START_TAG )
        {
            ...
            {
                modelBase.setDependencyManagement( parseDependencyManagement( parser, strict, source, modelBase ) );
            }
            else if ( checkFieldWithDuplicate( parser, "dependencies", null, parsed ) )
            {
                java.util.List<Dependency> dependencies = new java.util.ArrayList<Dependency>();
        ...
        while ( ( strict ? parser.nextTag() : nextTag( parser ) ) == XmlPullParser.START_TAG )
        {
            ...
            else if ( checkFieldWithDuplicate( parser, "dependencies", null, parsed ) )
            {
                ...
                while ( parser.nextTag() == XmlPullParser.START_TAG )
                {
                    if ( "dependency".equals( parser.getName() ) )
                    {
                        dependencies.add( parseDependency( parser, strict, source, null ) );
                    }
                    else
                    {
                        checkUnknownElement( parser, strict );
            ...
            throws IOException, XmlPullParserException
    {
        ...
        while ( ( strict ? parser.nextTag() : nextTag( parser ) ) == XmlPullParser.START_TAG )
        {
            ...
            {
                profile.setDependencyManagement( parseDependencyManagement( parser, strict, source, null ) );
            }
            else if ( checkFieldWithDuplicate( parser, "dependencies", null, parsed ) )
            {
                java.util.List<Dependency> dependencies = new java.util.ArrayList<Dependency>();
